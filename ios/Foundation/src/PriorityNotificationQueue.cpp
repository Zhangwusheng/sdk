...
PriorityNotificationQueue::PriorityNotificationQueue(int maxItems)
{
    _maxItems = maxItems;
}
...
//    if( _maxItems>0 &&  _maxItems <= _nfQueue.size() ){
//        NfQueue::iterator it = _nfQueue.end();
//        --it;
//        
//        //item to insert has greater priority than tail item
